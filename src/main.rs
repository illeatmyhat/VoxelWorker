...
//! shell LIB module tree [`voxel_worker::windowed`] — the bin depends on the lib, and the lib
//! already carries the winit/egui/wgpu deps, so the app logic is dep-clean there. This binary
//! just hands control to [`voxel_worker::windowed::run`].
