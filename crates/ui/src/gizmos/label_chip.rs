...
/// the axis hue. This IS the constraint vocabulary made legible: the snap says what it caught,
/// the by-product a solver would name a constraint. Returns the chip's rect so a caller can stack
/// chips.
