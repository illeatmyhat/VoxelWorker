//! `circle-center-diameter` — click the centre, drag the radius.
//!
//! The four circle tools are one ring differing only in WHICH points are accented, because which
//! points you click is the entire difference between them. Here it is the centre and one point on
