...
//!
//! A **target reticle**: four inward ticks with a centre gap converging on a node — "a point
...
//! rest of the create shelf: the centre is a [`Mark::Node`] rather than a hand-spelled `Fill`
...
//! the reticle centres on 9,9 instead of 9,10, where the old drawing sat a half unit low
...
pub(super) const DRAW: &[Mark] = &[
    // The four inward reticle ticks, with a centre gap the point sits in.
    Mark::Line {
