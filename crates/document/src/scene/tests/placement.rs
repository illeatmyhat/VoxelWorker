use super::*;
use crate::scene::producers::outset_voxels_at;
...
use crate::voxel::SdfShape;
    ...
    fn walk_leaf_aabbs_intersecting(
        ...
        scene.for_each_leaf(&mut |world_offset_voxels, _offset_local_voxels, _rotation, body, _grid_on_faces, _operation, outset, _scope_path| {
