...
- **Status:** Accepted (2026-07-18 — design grill; **implementation not started**).
  **Amended 2026-07-31: SHIPPED** — the field trait, the half-space cutter and the emboss
  arm are all in the runtime. **Decision 1's premise corrected by ADR 0021**: `DebugCloudField` is *not* fieldless, and
